<?php
$themename = "techrocket";
$shortname = "techrocket";
...
$options = array(
    ...
    array("name" => "Theme Stylesheet",
        ...
        "type" => "select",
        "std" => "default.css",
        "options" => array("default.css", "blue.css", "green.css", "red.css"),
    ...
    array("name" => "Contact Form E-mail",
        ...
        "desc" => "Input your e-mail address to receive e-mails from contact form.",
    ),
    ...
    array("name" => "Footer Credit",
        ...
        "type" => "textarea",
        "std" => "<a href=\"http://www.theme-rocket.com\">WordPress Theme</a> designed by <a href=\"http://www.theme-rocket.com\">Theme rocket</a>",
        "desc" => "desc",),
    array("type" => "clearfix",),
    array("name" => "general-1",
        "type" => "subcontent-end",),
    ...
    array("name" => "Enter Your Custom RSS Link",
        ...
        "type" => "text",
        "std" => "http://feeds.feedburner.com/techrocket",
        "desc" => "desc.",),
    array("name" => "Enter Your Newsletter Link",
        "id" => $shortname . "_newsletter_url",
        "type" => "text",
        "std" => "http://eepurl.com/xC4jr",
        "desc" => "desc.",),
    array("name" => "Enter Your Google+ Profile Link",
        "id" => $shortname . "_google_plus_url",
        "type" => "text",
        "std" => "https://plus.google.com/116387478398345310130",
        "desc" => "desc.",),
    array("name" => "Enter Your Twitter Profile Link",
        "id" => $shortname . "_twitter_url",
        "type" => "text",
        "std" => "http://twitter.com/theme_rocket",
        "desc" => "desc.",),
    array("name" => "Enter Your Facebook Page Link",
        "id" => $shortname . "_facebook_url",
        "type" => "text",
        "std" => "http://www.facebook.com/wordpress",
        "desc" => "desc.",),
    array("type" => "clearfix",),
    array("name" => "general-2",
        "type" => "subcontent-end",),
...
//-------------------------------------------------------------------------------------//
    ...
    array("name" => "layout-1",
        "type" => "subcontent-start",),
    array("name" => "Enable Featured Content on homepage",
        "id" => $shortname . "_featured_content_enable",
        "type" => "checkbox",
        "std" => "on",
        "desc" => "desc."),
    array("name" => "Input comma-separated tags for Featured Content",
        "id" => $shortname . "_featured_post_tags",
        "type" => "text",
        "std" => "featured, breaking",
        "desc" => "desc",),
    array("name" => "Number of posts to show on Featured Content",
        "id" => $shortname . "_featured_post_num",
        "type" => "text",
        "std" => "5",
        "desc" => "desc",),
    array("name" => "Number of excerpt characters to show on Featured Posts",
        "id" => $shortname . "_featured_post_char_num",
        "type" => "text",
        "std" => "200",
        "desc" => "desc",),
    array("name" => "Number of excerpt characters to show on Loop Posts",
        "id" => $shortname . "_loop_post_char_num",
        "type" => "text",
        "std" => "240",
        "desc" => "desc",),
    array("name" => "Select the Pagination Style",
        "id" => $shortname . "_pagination_style",
        "type" => "select",
        "std" => "Infinite Scroll",
        'options' => array("Infinite Scroll", "Numeric Pagination"),
        "desc" => "desc",),
    array("type" => "clearfix",),
    array("name" => "layout-1",
        "type" => "subcontent-end",),
...
//-------------------------------------------------------------------------------------//
    ...
    array("name" => "advertisements-1",
        "type" => "subcontent-start",),
    array("name" => "Enable header ad (728x90)",
        "id" => $shortname . "_header_ad_enable",
        "type" => "checkbox",
        "std" => "false",
        "desc" => "Ad block on header.",),
    array("name" => "Enable content ad (728x90)",
        "id" => $shortname . "_content_ad_enable",
        "type" => "checkbox",
        "std" => "false",
        "desc" => "Ad block on top of the content loop.",),
    array("name" => "Enable single ad (728x90)",
        "id" => $shortname . "_single_ad_enable",
        "type" => "checkbox",
        "std" => "false",
        "desc" => "Ad block on single posts.",),
    array("name" => "Input header ad code",
        "id" => $shortname . "_header_ad_code",
        "type" => "textarea",
        "std" => "",
        "desc" => "desc",),
    array("name" => "Input content ad code",
        "id" => $shortname . "_content_ad_code",
        "type" => "textarea",
        "std" => "",
        "desc" => "desc",),
    array("name" => "Input single ad code",
